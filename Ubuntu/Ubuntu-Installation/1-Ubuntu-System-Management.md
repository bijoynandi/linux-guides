...
Total Allocated:    476GB (1+16+309+150)
Smart Buffers:      84GB (distributed within partitions)
Actual Usage:       ~392GB
...
#### **In `/` (309GB) - The System Powerhouse**:

🐧 Base Ubuntu:           ~15GB
🛠️ All your software:     ~40GB
🐳 Docker + containers:   ~20GB
🖥️ Windows VM:            ~180GB
📝 Logs + cache:          ~10GB
🚀 Updates buffer:        ~20GB
🆘 Emergency space:       ~24GB  ← Your safety net!
──────────────────────────────
Total usage:              ~309GB ✅
...
| **🏠 /** | 309GB | 265GB | 44GB | Everything system + VM 🖥️ |
...
Your 309GB `/` and 150GB `/home` with smart buffer management will keep you happy for years to come! 🎯
